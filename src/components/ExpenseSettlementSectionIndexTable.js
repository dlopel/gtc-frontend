...
export default function ExpenseSettlementSectionIndexTable({ items }) {
    ...
    const SelectYesNoColumnFilter = ({ column: { filterValue, setFilter } }) => {
        const options = [{ label: 'SI', value: true }, { label: 'NO', value: false }]
        return (
            <select
    ...
    const columns = useMemo(() =>
        [
            {
                Header: 'Cod Liq',
                accessor: 'expenseSettlementFormattedId',
                Cell: ({ row, value }) => (
            ...
            {
                Header: '¿Nos debe?',
                accessor: 'favorsTheCompany',
                Cell: ({ value }) => value != null ? value ? 'SI' : 'NO' : '',
                Filter: SelectYesNoColumnFilter
            },
            {
                Header: '¿Cancelado?',
                accessor: 'cancelled',
